...
Let’s plot `mpg` vs `disp` for both mtcars and after the scaled fata in
`mtscale`
...
\#better representation of the data– it hasnt been scaled to the vector
with the biggest frame.
...
> Q4. Q4. From your results, what proportion of the original variance is
> captured by the first principal components (PC1)?

\#PC1 proportion of variance = 44.27%

> Q5. How many principal components (PCs) are required to describe at
> least 70% of the original variance in the data? \#The first 3 PC1-3

> Q6. How many principal components (PCs) are required to describe at
> least 90% of the original variance in the data? \# the first 7 PC1-7
...
> understand? Why? This plot has a lot of noise ande it is too hard to
> read and understand.
...
> you notice about these plots? There is more overlap between PC1 and
> PC2
...
\#This is pretty difficult to decipher between cutting into different
clusters for each diagnosis because the more clusters the harder to
determine the correct points vs clustering into might lead you to
...
> dataset? Explain your reasoning. \#The method that gives me the best
> results is using “ward.D2” because it considers each point distance
> between the centroids of the clusters being merged giving the best
> clustering method for PCA data.
...
![](class08_files/figure-commonmark/unnamed-chunk-52-1.png)
